...
import tech.ims.loans_api.domain.exceptions.LoanNotAvailableException;
...
class LoanTest {
    ...
    class isPersonalLoanAvailable {
        ...
        @Test
        void shouldBeAvailableWhenIncomeIsBetween3kAnd5kAbdAgeIsLessThan30AndLocationIsSP() {
